...
describe('Trie', () => {
  test('should insert and find strings', () => {
    ...
    expect((trieSearch<number>(trie, 'car') as TrieNode<number>)._d).toEqual([0])
    expect((trieSearch(trie, 'carwheel') as TrieNode<number>)._d).toEqual([1])
    expect((trieSearch(trie, 'cat') as TrieNode<number>)._d).toEqual([2])
    expect((trieSearch(trie, 'zebra') as TrieNode<number>)._d).toEqual([3, 4])
